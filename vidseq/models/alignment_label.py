"""AlignmentLabel model for storing front/rear keypoint annotations."""
...
class AlignmentLabel(Base):
    """Per-frame alignment labels with front and rear keypoint coordinates.

    Used for training the egocentric alignment model. Coordinates are
    normalized (0-1) relative to cropped frame dimensions.
    """
    __tablename__ = "alignment_labels"
    ...
    __table_args__ = (
        ...
        Index("ix_alignment_label_video_frame", "video_id", "frame_idx", unique=True),
    )
