...
const {
    ...
    connectPoseTrainingStream(projectId.value!)
)
...
async function loadTrainingStatus() {
    ...
    try {
        // Connect to stream to get current state
        startStream()
    } catch (e) {
        console.error('Failed to load pose training status:', e)
    }
}
